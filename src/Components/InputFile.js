...
const InputFile = (props) => {
  ...
  return (
    <div className="container">
      ...
      <input id="input" type="file" accept="application/pdf" onChange={handleChange} ref={input}/>

      <div className="bar-buttons">
        <div id="content-bar" className="progressbar-container" ref={contentBar}>
          <div id="bar" className="progressbar" ref={bar}></div>
        </div>

        <button id="close-btn" className="button-cancel" type="button" onClick={handleClick} ref={closeBtn}>
          x
        </button>
      </div>
    </div>
